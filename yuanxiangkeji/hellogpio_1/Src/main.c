...
4.点击.uvprojx打开工程；
5.单机魔法棒，然后在弹出的 Option for Target 对话框中选择Output选项卡，将 Name of Excuteable 编辑框内容替换为新工程名；
6.单机魔法棒，然后在弹出的 Option for Target 对话框中选择Debug选项卡，重新设置仿真器参数；
7.重新编译工程，即可Download运行。
*************************************************************************************/
